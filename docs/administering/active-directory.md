...
![Screenshot of this step](azuread/01.png)

- Click "Active Directory" in the sidebar.

![Screenshot of this step](azuread/02.png)

- Choose the directory you wish to use to sign into Sandstorm.

![Screenshot of this step](azuread/03.png)

- Click "Applications" in the top bar.

![Screenshot of this step](azuread/04.png)

- Choose "Add" from the bottom bar (NOT "+ New").

![Screenshot of this step](azuread/05.png)

- Choose "Add an application from the gallery"

![Screenshot of this step](azuread/07.png)
...
![Screenshot of this step](azuread/08.png)

- Enter name: "Sandstorm". Click the checkmark in the lower-right.

![Screenshot of this step](azuread/09.png)

- Choose "Configure single sign-on"

![Screenshot of this step](azuread/10.png)

- Choose "Microsoft Azure AD Single Sign-On". Click the "next" arrow.

![Screenshot of this step](azuread/11.png)
...
![Screenshot of this step](azuread/13-blanked.png)
...
![Screenshot of this step](azuread/16.png)
...
![Screenshot of this step](azuread/22.png)

- The system will ask you if you are sure. Click "Yes" to confirm.

![Screenshot of this step](azuread/23.png)
...
![Screenshot of this step](adfs/01.png)
...
![Screenshot of this step](adfs/02.png)

- You will see the "Add Relying Party Trust Wizard." Click "Start."

![Screenshot of this step](adfs/03.png)
...
![Screenshot of this step](adfs/26-blanked.png)
...
![Screenshot of this step](adfs/12.png)

- Click "Add Rule...".

![Screenshot of this step](adfs/13.png)

- Under "Claim rule template", choose: "Transform an Incoming Claim". Click "Next."

![Screenshot of this step](adfs/14.png)
...
![Screenshot of this step](adfs/15.png)

- Click "OK" to finish editing claim rules.

![Screenshot of this step](adfs/16.png)
...
![Screenshot of this step](adfs/26.png)

This concludes setting up Windows Server Active Directory with Sandstorm! If you have any questions
or need further help, please [email the support community](https://groups.io/g/sandstorm-user-group)! We'd be honored to work with you to get
